        ...
        @forelse($categories as $category)
            <li wire:key="{{ $category->id }}"
                ...
                <div class="flex space-x-1">
                    ...
                    <button wire:click.stop="deleteCategory({{ $category->id }})" class="text-gray-800 dark:text-white hover:text-red-800 transition duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <ul>
                @forelse($archivedCategories as $archivedCategory)
                    <li wire:key="archived-{{ $archivedCategory->id }}"
                        ...
                        <div class="flex space-x-1">
                            <button wire:click="unarchiveCategory({{ $archivedCategory->id }})" class="dark:hover:text-gray-600  hover:text-white transition duration-300">
            ...
            <ul>
                @forelse($trashedCategories as $trashedCategory)
                    <li wire:key="trashed-{{ $trashedCategory->id }}"
                        ...
                        <div class="flex space-x-1">
                            <button wire:click="restoreCategory({{ $trashedCategory->id }})" class="hover:text-green-300  transition duration-300">
