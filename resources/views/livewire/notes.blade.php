            ...
            <ul>
                @forelse($archivedNotes as $archivedNote)
                    <li wire:key="archived-{{ $archivedNote->id }}"
                        ...
                        <div class="flex space-x-1">
                            <button wire:click="unarchiveNote({{ $archivedNote->id }})" class="dark:hover:text-gray-600  hover:text-white transition duration-300">
            ...
            <ul>
                @forelse($trashedNotes as $trashedNote)
                    <li wire:key="trashed-{{ $trashedNote->id }}"
                        ...
                        <div class="flex space-x-1">
                            <button wire:click="restoreNote({{ $trashedNote->id }})" class="hover:text-green-300 transition duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     stroke-width="1.5" stroke="currentColor" class="size-5">
                                    <path stroke-linecap="round" stroke-linejoin="round"
